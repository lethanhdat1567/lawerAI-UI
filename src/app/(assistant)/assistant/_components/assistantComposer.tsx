...
export function AssistantComposer({
  ...
  return (
    <div className="shrink-0 border-t border-border bg-background/95 px-3 py-3 backdrop-blur-sm md:px-6">
      <div
        className={cn(
          "mx-auto max-w-3xl rounded-none border border-border bg-card px-3 py-2 shadow-lg backdrop-blur-sm md:px-4 md:py-3",
          locked && "opacity-80",
        )}
      >
        <div className="flex items-end gap-2">
          ...
          <Button
            ...
            onClick={() => onSubmit()}
            className="shrink-0 rounded-none bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-40"
            aria-label="Gửi"
          >
