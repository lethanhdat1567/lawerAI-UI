    ...
    <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border px-3 md:px-4">
      ...
      <div className="flex shrink-0 items-center gap-1">
        ...
        {isDemoLoggedIn ? (
          <span
            className={cn(
              "flex size-8 items-center justify-center rounded-none border border-border bg-muted text-xs font-semibold text-foreground",
            )}
          ...
          <Link
            href="/login"
            className="rounded-none border border-border bg-transparent px-3 py-1.5 text-xs font-semibold text-foreground hover:bg-muted"
          >
            Đăng nhập
          </Link>
        )}
