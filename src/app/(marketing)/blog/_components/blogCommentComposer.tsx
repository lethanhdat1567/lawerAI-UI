...
import { blogMeCreateComment } from "@/lib/blog/blogApi";
import { useAuthStore } from "@/stores/auth-store";

export function BlogCommentComposer({ postId }: { postId: string }) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setSubmitting(true);
    try {
      await blogMeCreateComment(postId, { body: body.trim(), parentId: null });
  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={4}
        placeholder="Chia sẻ góc nhìn hoặc trích dẫn…"
