// src/app/(marketing)/contributors/_components/contributors-page-layout.tsx
import type { ReactNode } from "react";

interface ContributorsPageLayoutProps {
  title: string;
  description?: string;
  children: ReactNode;
}

export function ContributorsPageLayout({
  title,
  description,
  children,
}: ContributorsPageLayoutProps) {
  return (
