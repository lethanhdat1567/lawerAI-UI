    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2 border-b border-border p-3">
        <Button
          ...
          className="h-10 flex-1 justify-start gap-2 rounded-xl border border-border bg-secondary px-3 text-sm font-medium text-secondary-foreground hover:bg-muted"
        >
