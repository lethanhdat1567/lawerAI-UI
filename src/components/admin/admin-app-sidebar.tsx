// src/components/admin/admin-app-sidebar.tsx
"use client";
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="border-b border-sidebar-border px-2 py-3">
        <Link
          href="/admin"
          className="flex items-center gap-2 rounded-md px-2 py-1 font-heading text-sm font-bold tracking-tight text-sidebar-foreground hover:bg-sidebar-accent"
        >
